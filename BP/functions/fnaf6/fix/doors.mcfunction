...
execute if score left_light doors matches 1 run setblock 22 -59 49 light_block 3
execute if score left_light doors matches 0 run setblock 22 -59 49 fnaf:black_block

execute if score right_light doors matches 1 run setblock 22 -59 53 light_block 3
