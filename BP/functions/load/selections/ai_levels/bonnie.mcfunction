...
execute as @a[hasitem={item=fnaf:bonnie_diff_up}] run scoreboard players set night fnaf1 7
execute as @a[hasitem={item=fnaf:bonnie_diff_down}] run scoreboard players set night fnaf1 7
