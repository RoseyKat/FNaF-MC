...
execute if score power fnaf2 matches 1.. if score bottom_light doors matches 0 run fill 29 -56 53 37 -56 53 air
...
execute if score power fnaf2 matches 1.. if score left_light doors matches 0 run setblock 22 -59 49 air
...
execute if score power fnaf2 matches 1.. if score right_light doors matches 0 run setblock 22 -59 57 air
