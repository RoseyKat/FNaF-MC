...
# Lights:
execute if score left_light doors matches 1 run setblock 25 -60 47 light_block ["block_light_level":15]
...
execute if score right_light doors matches 1 run setblock 25 -60 53 light_block ["block_light_level":15]
