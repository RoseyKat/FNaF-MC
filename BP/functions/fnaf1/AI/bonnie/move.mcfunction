...
execute if score loc bonnie_ai matches 8 if score move_to bonnie_ai matches 2 if score cheats fnaf1 matches 1 run tellraw @a {"rawtext":[{"text":"Bonnie: Supply Closet > West Hallway"}]}
