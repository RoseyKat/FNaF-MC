...
execute if score loc bonnie_ai matches 1 if score move_to bonnie_ai matches 1..2 run tellraw @a {"rawtext":[{"text":"Bonnie: Stage > Dining Hall"}]}
...
execute if score loc bonnie_ai matches 2 if score move_to bonnie_ai matches 3 run tellraw @a {"rawtext":[{"text":"Bonnie: Dining Hall > Parts & Service"}]}
...
execute if score loc bonnie_ai matches 2 if score move_to bonnie_ai matches 3..4 run tellraw @a {"rawtext":[{"text":"Bonnie: Dining Hall > West Hallway"}]}
...
execute if score loc bonnie_ai matches 5 if score move_to bonnie_ai matches 4..5 run tellraw @a {"rawtext":[{"text":"Bonnie: Parts & Service > Dining Hall"}]}
...
execute if score loc bonnie_ai matches 7 if score move_to bonnie_ai matches 1 run tellraw @a {"rawtext":[{"text":"Bonnie: West Hallway > Supply Closet"}]}
...
execute if score loc bonnie_ai matches 7 if score move_to bonnie_ai matches 3 run tellraw @a {"rawtext":[{"text":"Bonnie: West Hallway > South West Hallway"}]}
...
execute if score loc bonnie_ai matches 7 if score move_to bonnie_ai matches 5 run tellraw @a {"rawtext":[{"text":"Bonnie: West Hallway > Dining Hall"}]}
...
execute if score loc bonnie_ai matches 8 if score move_to bonnie_ai matches 2 run playsound fnaf1.steps @a
execute if score loc bonnie_ai matches 8 if score move_to bonnie_ai matches 2 run tellraw @a {"rawtext":[{"text":"Bonnie: Supply Closet > West Hallway"}]}
...
execute if score loc bonnie_ai matches 9 if score move_to bonnie_ai matches 1 run tellraw @a {"rawtext":[{"text":"Bonnie: South West Hallway > West Hallway"}]}
...
execute if score loc bonnie_ai matches 9 if score move_to bonnie_ai matches 2 run tellraw @a {"rawtext":[{"text":"Bonnie: South West Hallway > Supply Closet"}]}
...
execute if score loc bonnie_ai matches 7 if score move_to bonnie_ai matches 2 run tellraw @a {"rawtext":[{"text":"Bonnie: West Hallway > Office"}]}
...
execute if score loc bonnie_ai matches 9 if score move_to bonnie_ai matches 4 run tellraw @a {"rawtext":[{"text":"Bonnie: South West Hallway > Office"}]}
...
execute if score loc bonnie_ai matches 12 if score move_to bonnie_ai matches 1 run tellraw @a {"rawtext":[{"text":"Bonnie: Office > West Hallway"}]}
...
execute if score loc bonnie_ai matches 12 if score move_to bonnie_ai matches 5 run tellraw @a {"rawtext":[{"text":"Bonnie: Office > South West Hallway"}]}
