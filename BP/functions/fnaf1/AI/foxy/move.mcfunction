...
execute if score loc foxy_ai matches 2 if score @a[tag=guard] camera matches -1 if score moved foxy_ai matches 1 if score cheats fnaf1 matches 1 run tellraw @a {"rawtext":[{"text":"Foxy: Stage 2 > Stage 3"}]}
...
execute if score loc foxy_ai matches 3 if score @a[tag=guard] camera matches -1 if score moved foxy_ai matches 2 if score cheats fnaf1 matches 1 run tellraw @a {"rawtext":[{"text":"Foxy: Stage 3 > Stage 4"}]}
