...
execute if score loc freddy_ai matches 1 if score @a[tag=guard] camera matches -1 if score moved freddy_ai matches 0 if score cheats fnaf1 matches 1 run tellraw @a {"rawtext":[{"text":"Freddy: Stage > Dining Hall"}]}
...
execute if score loc freddy_ai matches 2 if score @a[tag=guard] camera matches -1 if score moved freddy_ai matches 1 if score cheats fnaf1 matches 1 run tellraw @a {"rawtext":[{"text":"Freddy: Dining Hall > Bathroom"}]}
...
execute if score loc freddy_ai matches 3 if score @a[tag=guard] camera matches -1 if score moved freddy_ai matches 2 if score cheats fnaf1 matches 1 run tellraw @a {"rawtext":[{"text":"Freddy: Bathroom > Kitchen"}]}
...
execute if score loc freddy_ai matches 4 if score @a[tag=guard] camera matches -1 if score moved freddy_ai matches 3 if score cheats fnaf1 matches 1 run tellraw @a {"rawtext":[{"text":"Freddy: Kitchen > East Hallway"}]}
...
execute if score loc freddy_ai matches 10 if score @a[tag=guard] camera matches -1 if score moved freddy_ai matches 4 if score cheats fnaf1 matches 1 run tellraw @a {"rawtext":[{"text":"Freddy: East Hallway > South East Hallway"}]}
...
execute if score loc freddy_ai matches 11 if score @a[tag=guard] camera matches -1 if score move_to freddy_ai matches 3 if score cheats fnaf1 matches 1 run tellraw @a {"rawtext":[{"text":"Freddy: South East Hallway > Office"}]}
